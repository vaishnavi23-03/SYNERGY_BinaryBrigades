...
CLIENT = ors.Client(key='5b3ce3597851110001cf62481a479f8d4af4449180a886671bfb40ff')
...
#     app.run(debug=True)
    ...
    start_address = data['startAddress']
    end_address = data['endAddress']
    battery_percentage = float(data['batteryPercentage']) 
    print(battery_percentage)
    battery_percentage= (battery_percentage/250)*100 # New: Get battery percentage from request
