...
const HeaderLinks: FC<HeaderLinksProps> = (props) => {
  const { variant, fixed, secondary, onOpen, logoText } = props;

  // Chakra Color Mode
  let inputBg: string = "#0F1535";
  let mainText: string = "gray.400";
  let navbarIcon: string = "white";
  let searchIcon: string = "white";
